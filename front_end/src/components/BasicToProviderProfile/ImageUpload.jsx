...
//     const response=await axios.post("http://localhost:3030/provider/mainImage" , path , {withCredentials:true})
...
//                 <img
//                   src={`http://localhost:3030/uploads/${img.image_path}`}
//                   alt="existing"
...
//               You have reached the maximum limit of images.
//             </p>
//           )}
